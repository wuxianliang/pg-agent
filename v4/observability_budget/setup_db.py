"""Create agent_v4_observability and load W1–W6 overlay. Own DB only."""
...
def main() -> int:
    ...
    for name, sql in [
        ...
        ("apply_queue_failure", "SELECT 1 FROM pg_proc WHERE proname='apply_queue_failure'"),
        ("steps.meta",
