-- ============================================================
-- PG-Agent v2 · plugin_brief_query（只读：预览当前会话 TEMP VIEW）
--
...
{"workbench_plugin":"plugin_brief_query","llm_tool":{"name":"wb_brief_query","description":"只读预览当前会话某个 TEMP VIEW：返回列结构加前 1..50 行（默认 20），truncated 标记是否截断；只解析本会话普通 TEMP VIEW","args":{"p_view":"text","p_limit":"integer"},"returns":"jsonb","session_scope":"current_session","capability":"read_only"}}
$wb$;
