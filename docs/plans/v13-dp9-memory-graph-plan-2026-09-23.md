...
> M4 ✅(2026-09-24 交付;A+D+E+F 352 PASS,kind/cap/窄 requeue 改动面同批跑 periphery(130 checks)/summary/twophase 回归全绿;偏差台账 #29–#36 见 v13/mgraph/README.md——含 enqueue 的 route 侧 decisions 再读面、fidelity include 阈绑定 consolidation_choice_min、succeeded-effect 同 turn 重试身份限制;**v13 剩余范围完结**)。
